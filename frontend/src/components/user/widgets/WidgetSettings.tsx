...
export function WidgetSettings({ onReset }: WidgetSettingsProps) {
  ...
  const handleReset = () => {
    localStorage.removeItem('user_widgets');
    onReset();
    setResetDialogOpen(false);
    window.location.reload(); // Recharger pour réinitialiser les widgets
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            <p>• Cliquez sur <strong>+</strong> pour ajouter des widgets</p>
            <p>• Survolez un widget et cliquez sur <strong>×</strong> pour le retirer</p>
